          ...
          <TableActionMenu
            items={[
              ...
              },
              {
                label: tx("edit"),
                icon: <Pencil size={14} />,
                onClick: () => router.push(`/store/products/${p.id}/edit`),
              },
              {
                label: tx("duplicate"),
                icon: <Copy size={14} />,
                      ...
                      return (
                        <th
                          ...
                          style={{
                            ...
                            // Force vertical stickiness: the pinning helper sets
                            // position:relative for unpinned cols (and sticky
                            // without top for pinned), which would override the
                            // `sticky top-0` class and break the sticky header.
                            position: "sticky",
                            top: 0,
