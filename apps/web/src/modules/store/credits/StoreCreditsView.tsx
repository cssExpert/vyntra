...
export function StoreCreditsView() {
  ...
  const paginatedRows = SAMPLE_CREDITS.slice(pageIndex * pageSize, (pageIndex + 1) * pageSize);
      ...
      {!isLoaded ? (
        ...
        >
          <PageHeader
            ...
            breadcrumbs={[{ label: "Store", href: "/store" }, { label: "Credits" }]}
          >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
            ...
            <div className="glass-card p-4 flex items-center gap-3">
              ...
              <div>
                <p className="text-xl font-extrabold text-foreground">{SAMPLE_CREDITS.length}</p>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="text-[13px] font-semibold text-muted-foreground">
                  ...
                  <th className="sticky top-0 bg-muted border-b border-border py-4 px-4">Email</th>
                  <th className="sticky top-0 bg-muted border-b border-border py-4 px-4">Balance</th>
                  <th className="sticky top-0 bg-muted border-b border-border py-4 px-4">Last Transaction</th>
