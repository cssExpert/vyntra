...
export function SeoDashboard({
  ...
  const stats = [
    {
      ...
      value: "94/100",
      change: "+1.8%",
      desc: "Based on 24 technical checkpoints",
      color: "from-emerald-500 to-teal-500",
    },
    {
      label: "Tracked Keywords in Top 3",
      value: "38",
      change: "+4 this week",
      desc: "Leading key commercial terms",
      color: "from-primary to-primary/60",
    },
    {
      label: "Est. Organic Search Traffic",
      value: "84.3k/mo",
      change: "+12.4%",
      desc: "Sustained post-update recovery",
      color: "from-sky-500 to-indigo-500",
    },
    {
      label: "XML Index Coverage",
      value: "98.2%",
      change: "1,248 Pages",
      desc: "0 crawl errors in Search Console",
  ...
  const keyRules = [
    {
      title: "E-E-A-T Gatekeeper Priority",
      text: "Google core indexing systems strictly assess transparency: visible expert authors, credible citations, and original non-templated statistics.",
      icon: ThumbsUp,
      tag: "Essential",
    },
    {
      title: "INP (Interaction to Next Paint) Shift",
      text: "Smooth scrolling and latency-free interactive inputs are now heavily favored under page experience, bypassing basic speed metrics.",
      icon: Sliders,
      tag: "Technical",
    },
    {
      title: "Contextual Topical Clusters",
      text: "Single landing pages fail without highly detailed surrounding content clusters. Deep interlinking of sub-topics proves category authority.",
      icon: Layers,
      tag: "On-Page",
    },
    {
      title: "Citable Snippet Structures",
      text: "Structure headings with direct, quotable QA formats to satisfy Gemini, Perplexity, and Google Search Generative Experiences (SGE).",
      icon: FileText,
      tag: "AI Search",
    },
  ];
        ...
        <div className="lg:col-span-2 bg-card border border-border p-6 rounded-2xl">
          ...
          <div className="mt-6 relative h-48 w-full">
            ...
            >
              ...
              <path
                d="M 0 100 Q 100 60 200 80 T 400 30 T 500 10"
                fill="none"
              ...
              />
              <path
                d="M 0 100 Q 100 60 200 80 T 400 30 T 500 10 L 500 150 L 0 150 Z"
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {keyRules.map((rule, idx) => (
            <div
              key={idx}
              className="p-5 bg-card border border-border rounded-2xl flex items-start gap-4"
            >
