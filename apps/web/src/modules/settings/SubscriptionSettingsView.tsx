    ...
    <div className="mx-auto max-w-7xl space-y-6">
      ...
      {packages.length > 0 && (
        <div className="@container space-y-4">
          ...
          <div className="grid gap-4 grid-cols-1 @md:grid-cols-2 @3xl:grid-cols-3 @5xl:grid-cols-4">
            {packages.map((pkg) => {
              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    className="mt-5 w-full cursor-not-allowed rounded-lg border border-border px-4 py-2.5 text-sm font-medium text-muted-foreground"
                  >
